      ...
      body: SafeArea(
        child: Form(
          ...
          child: SingleChildScrollView(
            ...
            child: BlocConsumer<BiodataBloc, BiodataState>(
              listener: (context, state) {
                ...
                if (!isInitialized && !(state.jobPreference == null)) {
                  ...
                  oldData = state.jobPreference;
                  experience.text = currentUser?.totalExperiences ?? "";
                  skills.text = currentUser?.skills?.join(", ") ?? "";
                  if (!(currentUser?.expectedSalary == null)) {
                    final salaryMap =
                        jsonDecode(currentUser!.expectedSalary!)
                  ...
                  _selectedOffDays =
                      state.jobPreference?.preferredOffDaysPerMonth ?? "";
                  _selectedLocation =
                      state.jobPreference?.preferredLocationInSingapore ?? "";
                  _willingToWork =
                      (state.jobPreference?.willingWorkOnRestDays ?? false)
                      ? "yes"
                      : "no";
                }
